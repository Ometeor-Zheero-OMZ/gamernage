...
use crate::db::models::todo::{
    RequestCompleteTodoItem, RequestCreateTodoItem, RequestDeleteTodoItem, RequestUpdateTodoItem,
};
...
pub async fn get_todos(req: HttpRequest, app_state: web::Data<AppState>) -> impl Responder {
    ...
    match user {
        Ok(user_data) => match todo_service.get_todos(user_data).await {
            ...
            Err(todo_error) => {
                error_log!(
                    "[todo_controller] - [get_todos] - [message: todo_error = {}]",
                    todo_error
                );
        ...
        Err(error) => {
            error_log!(
                "[todo_controller] - [get_todos] - [message: error = {}]",
                error
            );
...
pub async fn create_todo(
    ...
    match user {
        Ok(user_data) => match todo_service.create_todo(user_data, &todo_req).await {
            ...
            Err(todo_error) => {
                error_log!(
                    "[todo_controller] - [create_todo] - [message: todo_error = {}]",
                    todo_error
                );
                HttpResponse::InternalServerError().finish()
            }
        ...
        Err(error) => {
            error_log!(
                "[todo_controller] - [create_todo] - [message: error = {}]",
                error
            );
            HttpResponse::new(StatusCode::UNAUTHORIZED)
        }
...
pub async fn update_todo(
    ...
    match user {
        Ok(user_data) => match todo_service.update_todo(user_data, &todo_req).await {
            ...
            Err(todo_error) => {
                error_log!(
                    "[todo_controller] - [update_todo] - [message: todo_error = {}]",
                    todo_error
                );
                HttpResponse::InternalServerError().finish()
            }
        ...
        Err(error) => {
            error_log!(
                "[todo_controller] - [update_todo] - [message: error = {}]",
                error
            );
            HttpResponse::new(StatusCode::UNAUTHORIZED)
        }
...
pub async fn delete_todo(
    ...
    match user {
        Ok(user_data) => match todo_service.delete_todo(user_data, &todo_req).await {
            ...
            Err(todo_error) => {
                error_log!(
                    "[todo_controller] - [delete_todo] - [message: todo_error = {}]",
                    todo_error
                );
                HttpResponse::InternalServerError().finish()
            }
        ...
        Err(error) => {
            error_log!(
                "[todo_controller] - [delete_todo] - [message: error = {}]",
                error
            );
            HttpResponse::new(StatusCode::UNAUTHORIZED)
        }
...
pub async fn complete_todo(
    ...
    match user {
        Ok(user_data) => match todo_service.complete_todo(user_data, &todo_req).await {
            ...
            Err(todo_error) => {
                error_log!(
                    "[todo_controller] - [complete_todo] - [message: todo_error = {}]",
                    todo_error
                );
                HttpResponse::InternalServerError().finish()
            }
        ...
        Err(error) => {
            error_log!(
                "[todo_controller] - [complete_todo] - [message: error = {}]",
                error
            );
            HttpResponse::new(StatusCode::UNAUTHORIZED)
        }
