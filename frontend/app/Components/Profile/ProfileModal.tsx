...
function ProfileModal() {
  ...
  return (
    <div className="fixed left-0 top-0 z-50 h-full w-full bg-[#333]/30 overflow-hidden">
      <div
        ref={ref}
        className="py-5 px-6 max-w-[520px] w-full flex flex-col gap-3 bg-[#000D0D] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg shadow-md border-2 border-white"
      >
        <div className="absolute left-0 top-0 w-full h-[80px] bg-[#E6E6E6]/20 rounded-tr-md rounded-tl-md"></div>
        ...
        <div className="mt-4 relative flex justify-between">
          ...
          <div className="self-end flex items-center gap-2">
            <button className="flex items-center gap-2 border-2 border-[#323232]/10 rounded-md py-1 px-3 text-xs font-medium text-[#EDEDED]">
              {github} Github
            </button>
            <button className="flex items-center gap-2 border-2 border-[#323232]/10 rounded-md py-1 px-3 text-xs font-medium text-[#EDEDED]">
              {check} Verified
        ...
        <div>
          <h1 className="text-lg text-[#EDEDED] font-bold">{name}</h1>
        ...
        >
          <div className="pt-2 grid grid-cols-[150px_1fr]">
            <label
              htmlFor="name"
              className="text-sm text-[#EDEDED] font-medium"
            >
              Full Name
            </label>
            <input
              ...
              className="py-[0.4rem] px-3 font-medium rounded-lg border border-white bg-[#E6E6E6]/20 text-[#EDEDED]"
            />
          </div>
          ...
          <div className="pt-4 grid grid-cols-[150px_1fr] border-t-2 border-t-[#323232]/10">
            ...
            <div className="relative w-full">
              <input
                ...
                className="w-full py-[0.4rem] pl-9 pr-2 font-medium rounded-lg border border-white border-[#323232]/10 bg-[#E6E6E6]/20 text-[#EDEDED]"
              />
              <span className="absolute left-0 top-0 bottom-0 flex items-center px-3 text-gray-400">
                {mail}
              </span>
            </div>
          </div>
          ...
          <div className="pt-4 grid grid-cols-2 gap-4 border-t-2 border-t-[#323232]/10">
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="py-[0.4rem] px-3 font-medium rounded-lg border border-white border-[#323232]/10 bg-[#E6E6E6]/20 text-[#EDEDED]"
              />
            </div>
          ...
          <div className="flex justify-end">
            <button
              type="button"
              className="py-3 px-4 bg-blue-600 text-white text-sm font-medium rounded-md
          ...
          <div className="flex justify-end gap-4 border-t-2 border-t-[#323232]/10">
            <button
              className="mt-3 py-2 px-4 bg-[#EDEDED] text-sm font-medium rounded-md border-2 border-[#323232]/10
