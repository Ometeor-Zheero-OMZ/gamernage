...
function Profile() {
  ...
  return (
    <div className="m-6">
      <div
        className="px-2 py-4 flex items-center gap-3 bg-[#000D0D] rounded-[0.8rem]
        hover:bg-[#E6E6E6]/20 transition duration-300 ease-in-out cursor-pointer border-2 border-white hover:border-2 hover:border-white"
      ...
      >
        ...
        <div>
          <h1 className="flex flex-col text-xl">
            <span className="text-[#EDEDED] font-medium">Hello,</span>
            <span className="text-[#EDEDED] font-bold">{user?.name}</span>
          </h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-gray-200">
            ...
            <p className="pl-4 relative flex gap-2">
              ...
              <span className="font-medium text-4xl text-[#EDEDED]">
                {tasks?.length}
              </span>
            </p>
          </div>
