...
function Filters() {
  ...
  return (
    <div className="relative py-2 px-2 grid grid-cols-4 items-center gap-3 bg-[#000D0D] border-2 border-white rounded-md">
      <span
        className="absolute left-[5px] bg-[#E6E6E6]/30 rounded-md transition-all duration-300"
        style={{
